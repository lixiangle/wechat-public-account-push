...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx0bf5a2874974859e',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '8b664a87bc1c8d9a6cc9f231b34caf9d',
  ...
  USERS: [
    {
      ...
      id: 'oGvRB5-YvKFljVOJf5mC4ZiBEYiY',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'a0qiEMabEZluSdE-eLqIkzVPhNSB37C8gKloJjTNieE',
      // 所在省份
      province: '甘肃',
      // 所在城市
      city: '张掖',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '文娟', year: '1998', date: '08-05',
        },
        {
          type: '节日', name: '恋爱纪念日纪念日', year: '2015', date: '11-15',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '李四', year: '1998', date: '08-05',
        },
        {
          type: '节日', name: '恋爱纪念日', year: '2015', date: '11-15',
        }
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2015-11-15' },
