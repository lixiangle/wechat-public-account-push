  ...
  USERS: [
    {
      ...
      id: 'oGvRB5-rFiztg_O-m5evwWahEFy8',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'xwI8oeipdybxw7_ECJ6vNj4t3mI1RXZDQ_RkMYxxhwA',
      // 所在省份
      province: '甘肃',
      // 所在城市
      city: '张掖',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '你农历', year: '1998', date: '08-05',
        },
     
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '你阳历', year: '1998', date: '08-05',
        },
        {
